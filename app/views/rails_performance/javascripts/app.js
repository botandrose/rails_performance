    ...
    fetch(url, {
      ...
      .then(data => {
        ...
        if (lastDashboardData) {
          ...
          const newThroughputPoints = data.throughput.filter(point =>
            point[0] > lastDashboardData.lastThroughputTime
          );
          const newResponseTimePoints = data.response_time.filter(point =>
            point[0] > lastDashboardData.lastResponseTime
          );
